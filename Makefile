...
#CONNECTALFLAGS += --xci=$(IPDIR)/$(BOARD)/synthesis/pll_pma/pll_pma.qip
...
#	(cd $(BOARD); BUILDCACHE_CACHEDIR=$(BUILDCACHE_CACHEDIR) $(BUILDCACHE) quartus_sh -t ../hw/scripts/connectal-synth-pll.tcl)
endif
